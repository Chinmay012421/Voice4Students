...
from database import (
    ...
    get_all_users, set_temporary_password, change_password,
...
def reset_password(user_id):
    ...
    result = set_temporary_password(user_id, temporary_password)
    if result == "protected":
        return render_template("users.html", users=get_all_users(),
                               error="Main Admin passwords cannot be reset from this screen.")
    if result is None:
        return render_template("users.html", users=get_all_users(),
                               error="User not found.")
    return render_template("reset_password.html",
                           username=result, temporary_password=temporary_password)
