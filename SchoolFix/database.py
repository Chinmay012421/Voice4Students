...
def set_permanent_password(user_id, new_password):
    """Set a permanent password for a student or normal admin.

    Main Admin accounts are protected and cannot be changed through
    this user-management function. Passwords are always stored hashed.
    """
    conn = connect()
    cur = conn.cursor()
